...
function columnTitleBuilder(element, boardId) {
    return `<th class="text-light col-sm-3 " data-board-id=${boardId} data-column-id=${element.id} scope="col">${element.title.toUpperCase()}</th>`
}
